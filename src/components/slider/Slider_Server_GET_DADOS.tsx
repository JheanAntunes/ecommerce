...
import { product_ImgThumb_Description_formated_Array } from '@/utils/product_ImgThumb_formated_Array_ImgThumb'
...
async function Slider_Server_GET_DADOS() {
    ...
    const dataImageDescription =
        product_ImgThumb_Description_formated_Array(data)
